...
<script>
import {getRequest,postRequest} from '../request/http.js'
import axios from "axios";
axios.defaults.withCredentials = true
const BASE_URL = 'http://localhost:8085/identity'
...
export default {
  ...
  methods:{
    ...
    login_cancel(){
      getRequest("http://localhost:8085/identity/checkLoginStatus",{service:'http://localhost:8080/index.html'})
    },
    signup_check_id(){
